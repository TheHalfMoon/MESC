...
_ALL_ITEM_IDS = tuple(f"BT-{axis}-{index:03d}" for axis in "ABCDEF" for index in range(1, 41))
...
def test_schema_rejects_extra_key_float_and_noncanonical_item_id() -> None:
    ...
    candidate["negative_results"] = [{"category": "OTHER", "summary": "x", "item_id": "BT-A-041"}]
