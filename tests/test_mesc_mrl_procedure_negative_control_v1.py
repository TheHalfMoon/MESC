...
def test_valid_nested_control_identity_mutation_fails_closed() -> None:
    procedure = _candidate_procedure()
    case = _passing_case()
    report = build_procedure_negative_control_report(procedure, (case,))
    object.__setattr__(case, "evidence_artifact_sha256", "f" * 64)
...
def test_valid_control_failure_mode_mutation_fails_closed_on_disposition() -> None:
    case = _passing_case()
    object.__setattr__(case, "expected_failure_mode", "verification-failure")
