...
def test_project_state_matches_frozen_schema_without_freezing_live_gate_states(
    ...
    # MRL-0801..MRL-0808 have canonical trusted real-preflight evidence, so
    ...
    if rendered.commit_sha == snapshot.canonical_main_sha:
        expected_closed = {
            ...
            "MRL-0805": (
                ...
                "specs/mesc-research-loop-v1/real-preflight-evidence/MRL-0805.json",
            ),
            "MRL-0806": (
                "27ed7a990b6408b8972980d576da3692801dfdb3f7bd444beda1b0135f7d7de2",
                "specs/mesc-research-loop-v1/real-preflight-evidence/MRL-0806.json",
            ),
            "MRL-0807": (
                "1316c1ef2236203d4ad703cb269f8e30afc6d3dfe6d7a2df68128ec2a2edabab",
                "specs/mesc-research-loop-v1/real-preflight-evidence/MRL-0807.json",
            ),
            "MRL-0808": (
