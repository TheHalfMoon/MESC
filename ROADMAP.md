...
ADR-0038 is canonically effective after PR #460 protected merge and fresh-main qualification. CW-000, CW-001, CW-002, CW-003, CW-004 and CW-005 are closed canonically. CW-002 was activated under Issue #467 after the Founder ratified ADR-0039 under R6 on 2026-09-21 with Amendment A1 ([ratification record](specs/medscale-clinical-workspace-v1/adr-0039-founder-ratification.md)), and its implementation closed through PR #469 ([closeout record](specs/medscale-clinical-workspace-v1/cw-002-closeout.md)). CW-003 (provenance and audit spine) was activated under Issue #471 and closed through PR #472 ([closeout record](specs/medscale-clinical-workspace-v1/cw-003-closeout.md)). CW-004 (no-backflow and data-classification guard) was activated under Issue #474 and closed through PR #475 ([closeout record](specs/medscale-clinical-workspace-v1/cw-004-closeout.md)). CW-005 (synthetic encounter session lifecycle) was activated under Issue #477 and closed through PR #478 ([closeout record](specs/medscale-clinical-workspace-v1/cw-005-closeout.md)). CW-006, CW-009, CW-011, CW-013, CW-016 and CW-017 are eligible but not activated; CW-007 onward remains dependency-gated. PHI ingestion, clinical production use, EHR writes, Workspace-data training/evaluation, model/runtime execution, publication, paid compute, and new MRL Stage-4 attempts remain separately governed.
