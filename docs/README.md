...
- **Future MESC model-family strategy** → ADR-0036 and the 2026-09-05 performance-first
  program supersede the future-facing model-selection/naming assumptions in the 2026-08-18
  strategic model roadmap while preserving its historical Pilot-01 evidence.
