...
| **Clinical workspace planning** | [master specification](../specs/medscale-clinical-workspace-v1/README.md) · [capability map](../specs/medscale-clinical-workspace-v1/capability_map.md) · [data/security model](../specs/medscale-clinical-workspace-v1/data_security.md) · [task ledger](../specs/medscale-clinical-workspace-v1/tasks.md) — **proposed only; no implementation or PHI authority** |
