...
publish_test = "tests/test_mesc_mrl_0801_hf_publish_v1.py"
replace_once(
    publish_test,
...
publish_path = Path(publish_test)
...
"""
publish_path.write_text(publish_text, encoding="utf-8")

mount_test = "tests/test_mesc_mrl_0801_hf_mount_rollback_v1.py"
replace_once(
    mount_test,
...
acquisition_test = "tests/test_mesc_mrl_0801_hf_acquisition_v1.py"
replace_once(
    acquisition_test,
...
spec = "specs/mesc-experiment-0/mrl-0801-hf-acquisition-provenance-v1.md"
replace_once(
    spec,
